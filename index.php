<?php
	// session_start();
	if(isset($_POST['login'])) {echo "<script>window.location.href='lcp3-login.php'</script>";
	}
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
          ...
          <button class="btn btn btn-dark" type="login" name="login" id="login" >
            Log in
          </button>
          ...
          <div class="position-sticky pt-3">
            ...
            <ul class="nav flex-column" id="mainmenu" role="tablist">
              <li class="nav-item" role="presentation">
                <a class="nav-link active" id="home-menu" data-toggle="tab" href="#home" aria-controls="home"
                  aria-selected="true">
              ...
              <li class="nav-item" role="presentation">
                <a class="nav-link" id="document-menu" data-toggle="tab" href="#document" aria-controls="document"
                  aria-selected="false">
              ...
              <li class="nav-item" role="presentation">
                <a class="nav-link" id="cart-menu" data-toggle="tab" href="#cart" aria-controls="cart"
                  aria-selected="false">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="document" role="tabpanel" aria-labelledby="document-menu">
              ...
              <div class="table-responsive-sm">
                <table id="doctable" class="table table-striped table-bordered table-hover flex-wrap" width="100%"
                  cellspacing=" 0" >
                  <thead>
                    <tr>
            ...
            <form action="#" method="post">
              ...
              <div class="form-group mb-3">
                ...
                <div class="input-group bg-light" id="show_hide_password">
                  <input type="password" class="form-control" id="password" value="Passwords" name="password"
